...
> List all default next paths

##### `POST` /api/v2/paths/next

> Create a default next path

##### `PATCH` /api/v2/paths/next/{id}

> Update a default next path

##### `GET` /api/v2/paths/next/{next-path}

> Create a default next path

##### `DELETE` /api/v2/paths/next/{next-path}

> Delete a default next path
